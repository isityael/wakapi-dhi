...
| `security.cookie_key` /<br> `WAKAPI_COOKIE_KEY`                                             | -                                                | Base64-encoded key (decoding to at least 32 bytes) used to derive session and authentication keys. If empty, a random key is generated on startup.                              |
